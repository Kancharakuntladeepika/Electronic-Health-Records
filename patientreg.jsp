...
<div id="tooplate_wrapper">
	...
	<div id="site_title">
        ...
        <div class="content_box">
            <h2>Patient Form</h2>
		  <form action="patientregact.jsp" method="post" ><center>
					  <table width="567">
                        ...
                        <tr>
                             <tr>
                          <td width="238" height="43">Last Name</td>
                          <td width="317">
                          <input id="lname" name="lname" required class="text" placeholder="lName" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><select id="gender" name="gender" required style="width:175px;" class="text">
                            ...
                            <option>FEMALE</option>
                             ...
                             <tr>
                          <td width="238" height="43">Height</td>
                          <td width="317">
                          <input id="height" name="height" required class="text" placeholder="height" /></td>
                        </tr>
                         <tr>
                          <td width="238" height="43">Weight</td>
                          <td width="317">
                          <input id="weight" name="weight" required class="text" placeholder="weight" /></td>
                        </tr>
                        <tr>
                        
                          <td height="65">About</td>
                          <td>
