	...
	<div id="tooplate_header">
        ...
        <div id="tooplate_menu">
            <ul>
                ...
                <li><a href="history.jsp">Medical </a></li>                
...
<%@ page session="true" %>
        ...
        <%
                                                    ...
                                                    
						{
						   	...
						   	String query="select * from house.patient where fname='"+fname+"'"; 
        ...
        <tr>
          <td  width="145" align="left" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style3 style4 style14 style7 style15 style20 style8 style9" style="margin-left:20px;"><strong>Last Name</strong></div></td>
        ...
        <tr>
            <td   width="145" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style3 style4 style14 style7 style15 style20 style8 style9" style="margin-left:20px;"><strong>About</strong></div                        ></td>
