            ...
            <ul>
               <li><a href="ownerhome.jsp">Home</a></li>
                 <li><a href="viewprofile2.jsp">View Profile</a></li>
                  <li><a href="a.jsp">Appointment</a></li>
                <li><a href="editpatient.jsp">Edit patient</a></li>
                <li><a href="prescribe.jsp">Prescribe</a></li>                
...
<%@ page session="true" %>
        ...
        <%
                                                    ...
                                                    
						{
						   	...
						   	String query="select * from house.doctor where username='"+user+"'"; 
