	...
	<div id="tooplate_header">
        ...
        <div id="tooplate_menu">
            <ul>
                ...
                <li><a href="viewowner.jsp">View doctor</a></li>
...
<%@ page session="true" %>
          <%
						...
						{       Connection con=databasecon.getconnection();
						   	String query="select * from house.doctor"; 
...
<!--<form method="post" action="sendmail.jsp">
   <table align="center">
<tr>
<td><h2>Send Email to this group</h2>
    <tr><td><input type="text" name="Email" class="form-control"   placeholder="Email ID" size="50">


<tr><td><input type="text" name="subject" class="form-control"   placeholder="Email Subject" size="50">
<tr>
	<td>
<textarea name="body" rows="7" cols="" class="form-control" placeholder="Email Body"></textarea>
